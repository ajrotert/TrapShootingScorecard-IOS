...
namespace AR.TrapScorecard.ViewCells.TrapShooters
{
    ...
    {
        #region - variables
        public static readonly NSString Key = new NSString("TrapLayoutViewCell");
        ...
        public void SetupTrapLayoutViewCell(int numberShooters)
        {
            if (ImageView == null)
            {
            ...
            Shooter1.Image = numberShooters > 0 ? UIImage.FromBundle("TrapShooterIcon").ImageWithRenderingMode(UIImageRenderingMode.AlwaysTemplate) : null;
            Shooter1.TintColor = ColorConstants.PrimaryColor;
            StackView.AddArrangedSubview(Shooter1);

            Shooter2.Image = numberShooters > 1 ? UIImage.FromBundle("TrapShooterIcon").ImageWithRenderingMode(UIImageRenderingMode.AlwaysTemplate) : null;
            Shooter2.TintColor = ColorConstants.PrimaryColor;
            StackView.AddArrangedSubview(Shooter2);

            Shooter3.Image = numberShooters > 2 ? UIImage.FromBundle("TrapShooterIconAway").ImageWithRenderingMode(UIImageRenderingMode.AlwaysTemplate) : null;
            Shooter3.TintColor = ColorConstants.PrimaryColor;
            StackView.AddArrangedSubview(Shooter3);

            Shooter4.Image = numberShooters > 3 ? UIImage.FromBundle("TrapShooterIconFlipped").ImageWithRenderingMode(UIImageRenderingMode.AlwaysTemplate) : null;
            Shooter4.TintColor = ColorConstants.PrimaryColor;
            StackView.AddArrangedSubview(Shooter4);

            Shooter5.Image = numberShooters > 4 ? UIImage.FromBundle("TrapShooterIconFlipped").ImageWithRenderingMode(UIImageRenderingMode.AlwaysTemplate) : null;
